...
RUN chmod -R 777 /opt/atlassian/jira/logs /opt/atlassian/jira/work /opt/atlassian/jira/temp /var/atlassian/application-data/jira && echo "" > /opt/atlassian/jira/bin/user.sh
